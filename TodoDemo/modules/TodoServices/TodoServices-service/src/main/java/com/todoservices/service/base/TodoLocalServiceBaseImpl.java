...
package com.todoservices.service.base;
...
import com.todoservices.service.TodoLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.todoservices.service.impl.TodoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.todoservices.service.impl.TodoLocalServiceImpl
 * @generated
 */
public abstract class TodoLocalServiceBaseImpl
	...
	public Todo createTodo(long id) {
		return todoPersistence.create(id);
	}
	...
	public Todo deleteTodo(long id) throws PortalException {
		return todoPersistence.remove(id);
	}
	...
	public Todo fetchTodo(long id) {
		return todoPersistence.fetchByPrimaryKey(id);
	}
	...
	public Todo getTodo(long id) throws PortalException {
		return todoPersistence.findByPrimaryKey(id);
	}

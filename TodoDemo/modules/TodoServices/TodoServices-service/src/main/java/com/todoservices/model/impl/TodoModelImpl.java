...
import com.todoservices.model.TodoModel;
...
public class TodoModelImpl extends BaseModelImpl<Todo> implements TodoModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		{"id_", Types.BIGINT}, {"name", Types.VARCHAR}, {"done", Types.BOOLEAN},
		{"dueDate", Types.TIMESTAMP}, {"user", Types.BIGINT}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("user", Types.BIGINT);
	}

	public static final String TABLE_SQL_CREATE =
		"create table Todo_Todo (id_ LONG not null primary key,name VARCHAR(75) null,done BOOLEAN,dueDate DATE null,user LONG)";

	public static final String TABLE_SQL_DROP = "drop table Todo_Todo";

	public static final String ORDER_BY_JPQL = " ORDER BY todo.id ASC";

	public static final String ORDER_BY_SQL = " ORDER BY Todo_Todo.id_ ASC";
	 ...
	 */
	@Deprecated
	public static final long USER_COLUMN_BITMASK = 1L;
	...
	static {
		...
		attributeGetterFunctions.put("id", Todo::getId);
		attributeSetterBiConsumers.put(
			"id", (BiConsumer<Todo, Long>)Todo::setId);
		attributeGetterFunctions.put("name", Todo::getName);
		attributeSetterBiConsumers.put(
			"name", (BiConsumer<Todo, String>)Todo::setName);
		attributeGetterFunctions.put("done", Todo::getDone);
		attributeSetterBiConsumers.put(
			"done", (BiConsumer<Todo, Boolean>)Todo::setDone);
		attributeGetterFunctions.put("dueDate", Todo::getDueDate);
		attributeSetterBiConsumers.put(
			"dueDate", (BiConsumer<Todo, Date>)Todo::setDueDate);
		attributeGetterFunctions.put("user", Todo::getUser);
		attributeSetterBiConsumers.put(
			"user", (BiConsumer<Todo, Long>)Todo::setUser);
	...
	public long getOriginalUser() {
		return GetterUtil.getLong(this.<Long>getColumnOriginalValue("user"));
	}
	...
	public Object clone() {
		...
		todoImpl.setId(getId());
		todoImpl.setName(getName());
		todoImpl.setDone(isDone());
		todoImpl.setDueDate(getDueDate());
		todoImpl.setUser(getUser());
	...
	static {
		...
		columnBitmasks.put("done", 4L);

		columnBitmasks.put("dueDate", 8L);

		columnBitmasks.put("user", 16L);

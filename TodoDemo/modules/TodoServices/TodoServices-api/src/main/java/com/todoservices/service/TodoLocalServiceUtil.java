 ...
 * <code>com.todoservices.service.impl.TodoLocalServiceImpl</code> and
...
public class TodoLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.todoservices.service.impl.TodoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new todo
	 */
	public static Todo createTodo(long id) {
		return getService().createTodo(id);
	}
	 ...
	 */
	public static Todo deleteTodo(long id) throws PortalException {
		return getService().deleteTodo(id);
	}
	...
	public static Todo fetchTodo(long id) {
		return getService().fetchTodo(id);
	}

	public static List<Todo> findByUser(long user) {
		return getService().findByUser(user);
	}
	 ...
	 * @throws PortalException if a todo with the primary key could not be found
	 */
	public static Todo getTodo(long id) throws PortalException {
		return getService().getTodo(id);
	}
